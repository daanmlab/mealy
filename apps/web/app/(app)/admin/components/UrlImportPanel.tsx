      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div className="flex gap-2">
          <input
            ...
            required
            disabled={submitting}
            className="flex-1 px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-olive focus:border-transparent disabled:opacity-50"
          />
          <button
            type="submit"
            disabled={submitting || !url}
            className="px-4 py-2 bg-olive text-white text-sm font-medium rounded-lg hover:bg-olive-dark disabled:opacity-50 disabled:cursor-not-allowed transition-colors whitespace-nowrap"
          >
