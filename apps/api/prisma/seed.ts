...
async function main() {
  ...
  async function upsertRecipe(
    ...
    const ingRows = await prisma.ingredient.findMany({ where: { name: { in: ingredientNames } } });
  ...
  const seeded = await Promise.all([
    ...
    upsertRecipe('cmp748cet004a8rnxzyn06j88', {
      title: 'Honey chicken',
      description: 'Rustle up this family-friendly honey chicken, flavoured with garlic, soy sauce, lemon and ginger, in 30 minutes. Serve with rice and broccoli for a filling meal',
      cookTimeMinutes: 15,
      servings: 4,
    ...
    upsertRecipe('cmp748xis00518rnxc49krqdm', {
      ...
      cookTimeMinutes: 20,
      servings: 4,
      sourceUrl: 'https://www.bbcgoodfood.com/recipes/speedy-lentil-coconut-curry',
    ...
    upsertRecipe('cmp749fu9005o8rnxr6a4stt5', {
      ...
      description: 'Enjoy our creamy spinach chicken with plenty of sauce and rice or potatoes on the side. Serving four, it\'s an ideal midweek dinner for a family',
      cookTimeMinutes: 30,
      servings: 2,
    ...
    upsertRecipe('cmp74b4ow00758rnxa96ssay2', {
      ...
      cookTimeMinutes: 20,
      servings: 3,
      sourceUrl: 'https://www.bbcgoodfood.com/recipes/creamy-halloumi-tomato-curry',
      tagSlugs: ['quick', 'rice', 'vegetarian'],
      steps: [
